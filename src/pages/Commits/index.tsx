  ...
  return (
    <ul className="list-group">
      {commits?.[app.repo]?.map(commit => (
        <li key={commit.sha} className="list-group-item list-group-item-action list-group-item-light text-dark">
          <div className="d-flex align-items-center">
            <div className="flex-fill">
              <h5>
                <a href={commit.html_url} target="_blank" rel="noopener noreferrer" className="text-reset">
            ...
            <div className="btn-group">
              ...
              <a href={commit.html_url} target="_blank" rel="noopener noreferrer" className="btn btn-outline-primary">{commit.sha.slice(0, 7)}</a>
            </div>
          </div>
        </li>
      ))}
